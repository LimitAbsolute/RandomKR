...
'''
pack: 
pyinstaller -F random_kr_en.py -n "KR Series Random Challenge [en]" -i E:\编程作业\python\python_demo\pic\icon.png
...
GAME_CONFIG = {
    ...
    'kra': {
        ...
        'tower': ['Royal Archers', 'Paladin Covenant', 'Arcane Wizard', 'Tricannon', 'Ballista Outpost',
                  ...
                  'Twilight Longbows', 'Bog Hermit', 'Cannoneer Squad', 'Surge Colossus'],
